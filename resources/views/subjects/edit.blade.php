            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Subjects</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40">
                                    <div class="form-group">
                                        <div class="row">
                                            <label class="col-md-12" for="example-text">Subject Name</label>
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="example-text" class="form-control" placeholder="enter subject name" value="Jonathan Doe">
                                            </div>
                                        </div>
                                    </div>                                   
                                    <div class="form-group">
